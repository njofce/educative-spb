...
/**
 * A request wrapper that is able to cache the request body and return a request input stream when
 * required.
 */
public class CustomHttpRequestWrapper extends HttpServletRequestWrapper {
  ...
  public CustomHttpRequestWrapper(HttpServletRequest request) throws IOException {
    ...
    logger.info("Read body: {}", bodyInStringFormat);
  }

  /**
   * Read an input stream
   *
   * @param stream The input stream from the request
   * @param charset Specified encoding charset for the request body
   * @return request body
   * @throws IOException failure to read the stream
   */
